/**
 * This example is showing how we can use fyweight technique to save more space rather then use a huge boolean array to control the fromat text 
 */
...
/**
 * In this class we are using a boolean array to store the details of range to
 * apply the format which is just an over head to add more space
 * 
 * @author bada
 *
 */
...
/**
 * Modified formatted text which is used a flyweight technique TextRange to give
 * the text range rathe store in a separate array
 * 
 * @author bada
 *
 */
