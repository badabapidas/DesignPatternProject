 ...
 * Adding behavior without altering the class itself. Facilitates the addition of behaviors to individual objects without inheriting from them.
 * 
 * One way to do this is inherit one class and add aditional methods. But is the class is final then you cant extend that class then you have 
 * to create a reference of that class object and delegate all the needed calls and add aditional new methods.
 * 
 * Here we are trying to add new functionality for String class and as String class is final we cant just simply inherit that. So we created 
 * a String reference and delegate all the calls which are simply deligating the calls to String class. Then we added new method getNumberOfVowels()
 * which will return the no of vowels in a string. 
 * 
