/**
 * Examples for prototype design pattern
 * 
 * Here we are trying to copy the object using deep cloning using a markup interface Cloneable
 * But it is advice not to use cloneable
 * 
 */
